...
GameManager.prototype.setup = function () {
  ...
  this.tileTypes = [6,10,15];
  this.tilesSeen=this.tileTypes.slice();
  if (this.gameMode & 1) {
    this.tileTypes = [2];
    this.tilesSeen = [2];
  } 
...
GameManager.prototype.div = function (next, cur) {
  ...
  if(n<6){
    return s;
  }else if(n===8||n===9||n===15||n===24||n===80){
    return s;
  }
...
// Do theÃƒâ€šÃ‚Â factor extraction in the way yielding the least result
